            ...
            <div className="h-screen flex flex-col justify-center items-center text-center px-4 relative overflow-hidden">
                ...
                <div className="z-10 animate-fade-in-up">
                    ...
                    <p className="max-w-2xl mx-auto text-gray-400 mb-12 text-lg">
                        Mastering the Grid: OIDC; OAuth, PAR, and Finnish weirdness!
                    </p>
                    <button
                        onClick={handleEnter}
                        className="group relative px-8 py-4 bg-transparent border border-cyan-500 text-cyan-400 font-bold uppercase tracking-widest hover:bg-cyan-500/10 transition-all hover:scale-105"
                    >
                        Enter The System
